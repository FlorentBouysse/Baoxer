...
/**
 * @ORM\Entity(repositoryClass=StaminaRepository::class)
 */
class Stamina
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Boxer::class, mappedBy="stamina")
     */
    private $boxers;
    ...
    public function removeBoxer(Boxer $boxer): self
    {
        if ($this->boxers->removeElement($boxer)) {
            ...
            if ($boxer->getStamina() === $this) {
                $boxer->setStamina(null);
            }
        }
